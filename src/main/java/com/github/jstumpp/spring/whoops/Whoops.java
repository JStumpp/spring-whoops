 ...
 * <p> <strong>NOTE</strong>: This module is base on <a href="https://github.com/filp/whoops">whoops</a>
...
public class Whoops {
    ...
    public String prettyPage(ErrorAttributes errorAttributes, HttpServletRequest req, HttpServletResponse rsp) throws IOException, PebbleException {
        ...
        envdata.put("response", dump(() -> ImmutableMap.of("status", rsp.getStatus())));
        ...
        envdata.put("route", dump(() -> {
            ...
            return map
                    ...
                    .put("path", errorAtt.get("path")).build();
        }));
        /** request params */
        ...
        envdata.put("request params", hm0);
        /** request locals */
        HashMap<String, String> hm1 = new HashMap();
        Enumeration<String> attributeNames = req.getAttributeNames();
        while (attributeNames.hasMoreElements()) {
            String attributeName = attributeNames.nextElement();
            Enumeration<String> attributes = req.getHeaders(attributeName);
            while (attributes.hasMoreElements()) {
                hm1.put(attributeName, attributes.nextElement());
            }
        }
        envdata.put("request locals", hm1);
        /** http headers */
        ...
        while (headerNames.hasMoreElements()) {
            ...
            while (headers.hasMoreElements()) {
                hm2.put(headerName, headers.nextElement());
            }
        }
        envdata.put("request headers", hm2);
        /** session */
        HashMap<String, String> hm3 = new HashMap();
        Enumeration<String> sessionAttributeNames = req.getSession().getAttributeNames();
        while (sessionAttributeNames.hasMoreElements()) {
            String sessionAttributeName = sessionAttributeNames.nextElement();
            Object attribute = req.getSession().getAttribute(sessionAttributeName);
            hm3.put(sessionAttributeName, attribute.toString());
        }
        envdata.put("session", hm3);
    ...
    static Map<String, Object> frame(final ClassLoader loader, final SourceLocator locator,
        ...
        return ImmutableMap.<String, Object>builder()
                ...
                .put("open", String.format(openWith, filePath, line))
