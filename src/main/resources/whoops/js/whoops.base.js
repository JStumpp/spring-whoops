Zepto(function ($) {
    ...
    $frameContainer.on('click', '.frame.source', function () {
        var $this = $(this);
    ...
    var showEditorTooltip = function (elem, msg) {
        elem.setAttribute('class', 'editor-link tooltipped tooltipped-s');
        elem.setAttribute('aria-label', msg);
    };

    $openWith = $('.editor-link');
    $openWith.on('click', function (e) {
        var addressValue = $(this).attr("href");
        $.get(addressValue, function (response) {
            showEditorTooltip(e.target, 'Opening file in IntelliJ! Remember: "Allow unsiged Requests" in the IntelliJ settings.');
        });
        return false;
    });
